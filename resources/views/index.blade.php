...
@section('main')
    <div class="is-flex is-justify-content-space-between is-align-items-center container is-fluid" style="color: white;">
        <div class="column is-flex is-flex-direction-column is-align-items-center is-justify-content-start mt-5" style="height: 100%;">
            ...
            <div><a href="{{ route('profile', 0) }}" id="profile-rafi" class="button is-warning is-rounded mt-5 mb-5" type="button">Profile</div></a>
        ...
        <div class="column is-flex is-flex-direction-column is-align-items-center is-justify-content-start mt-5" style="height: 100%;">
            ...
            <a href="{{ route('profile', 1) }}"id="profile-sekar" class="button is-warning is-rounded mt-5 mb-5" type="button">Profile</a>
            {{-- <a class="button is-warning is-rounded mt-5 mb-5" href="">Profile</a> --}}
        </div>
        <div class="column is-flex is-flex-direction-column is-align-items-center is-justify-content-start mt-5" style="height: 100%;">
            ...
            <a href="{{ route('profile', 2) }}" id="profile-umar" class="button is-warning is-rounded mt-5 mb-5" type="button">Profile</a>
            {{-- <a class="button is-warning is-rounded mt-5 mb-5" href="">Profile</a> --}}
        </div>
    </div>
@endsection